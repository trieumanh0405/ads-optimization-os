...
const evidence = (level: "CAMPAIGN" | "ADSET" | "AD", budgetType: "CBO" | "ABO" | "NONE"): EntityEvidence => ({
  ...
  windows: {
    TODAY: { id: "TODAY", start: "2026-07-20", endExclusive: "2026-07-21", totals: { spend: 1000, result: 10, qualifiedResult: 0, revenue: 0, impressions: 10000, clicks: 100 }, value: 100, achievement: 1, rowCount: 1 },
    SHORT: { id: "SHORT", start: "2026-07-17", endExclusive: "2026-07-20", totals: { spend: 3000, result: 30, qualifiedResult: 0, revenue: 0, impressions: 30000, clicks: 300 }, value: 100, achievement: 1, rowCount: 3 },
...
const config: ProjectConfig = {
  ...
  primaryMetricKey: "CPL", target: 100, ruleSetId: "R", ruleVersion: 1, dataFreshnessHours: 6,
...
const rule = (id: string, actionCode: OptimizationRule["actionCode"], priority = 10): OptimizationRule => ({
  ...
  evidenceSource: "TODAY_PLUS_SHORT",
