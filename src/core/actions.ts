...
export function evidenceHash(recommendation: Recommendation): string {
  return createHash("sha256").update(JSON.stringify({
    entityId: recommendation.entityId, action: recommendation.recommendedAction,
    currentMetric: recommendation.currentMetric, score: recommendation.contextWeightedAchievement,
