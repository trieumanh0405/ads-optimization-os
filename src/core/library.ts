...
export const standardMetricLibrary: MetricDefinition[] = [
  ...
  { key: "CTR", label: "Click-through rate (%)", kind: "RATE", numerator: "clicks", denominator: "impressions", multiplier: 100, direction: "HIGHER_IS_BETTER", nullWhenDenominatorZero: true },
  ...
  { key: "CVR", label: "Conversion rate (%)", kind: "RATE", numerator: "result", denominator: "clicks", multiplier: 100, direction: "HIGHER_IS_BETTER", nullWhenDenominatorZero: true },
